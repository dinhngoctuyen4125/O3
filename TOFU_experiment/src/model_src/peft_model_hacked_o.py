...
from model_src.lora_model_hacked_o import LoraModel
    ...
    **Attributes**:
    ...
    def from_pretrained(
        ...
        **kwargs: Any,
        ...
        """
        ###modified
        from model_src.mapping_hacked_o import MODEL_TYPE_TO_PEFT_MODEL_MAPPING, PEFT_TYPE_TO_CONFIG_MAPPING
